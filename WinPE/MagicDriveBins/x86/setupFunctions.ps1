$windowTitle = 'MagicDrive Windows 32bit Installer'
...
$toolIndexFile = 'PortableTools-x86.csv'
...
Note: Windows Vista and later versions are supported, only Windows 32bit images are supported.
